...
def facecrop(org_path, save_path, face_detector, face_predictor, period=1, num_frames=10):
    ...
    cap_org.release()
    return
# set CUDA_VISIBLE_DEVICES=* python src/train_sbi.py src/configs/sbi/base.json -n sbi
...
if __name__ == '__main__':
    ...
    if args.dataset == 'Original':
        ...
        dataset_list = ['data/FaceForensics++/manipulated_sequences/{}/{}/'.format(i, args.comp) for i in ['Face2Face', 'Deepfakes', 'FaceSwap', 'NeuralTextures']]
